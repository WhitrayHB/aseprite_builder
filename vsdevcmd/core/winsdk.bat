...
if not "%WindowsSdkVersion%"=="" set "INCLUDE=%WindowsSdkDir%\include\%WindowsSDKVersion%\shared;%WindowsSdkDir%\include\%WindowsSDKVersion%\um;%WindowsSdkDir%\include\%WindowsSDKVersion%\winrt;%WindowsSdkDir%\include\%WindowsSDKVersion%\cppwinrt%__tmpwinsdk_include%"
set __tmpwinsdk_include=
